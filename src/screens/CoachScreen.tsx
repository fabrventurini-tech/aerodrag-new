...
export function CoachScreen() {
  ...
  const {
    ...
    isRecording: s.isRecording, activeAthleteId: s.activeAthleteId,
    athleteProfiles: s.athleteProfiles, batteryPct: s.batteryPct,
    currentLap: s.currentLap, coachStatus: s.coachStatus, coachErrorMsg: s.coachErrorMsg,
  })));
